...
namespace Microsoft.MixedReality.Toolkit.Examples.Demos
{
    ...
    public class InputDataExample : MonoBehaviour
    {
        ...
        private Tuple<InputSourceType, Microsoft.MixedReality.Toolkit.Handedness>[] inputSources = new Tuple<InputSourceType, Microsoft.MixedReality.Toolkit.Handedness>[]
        {
            ...
            new Tuple<InputSourceType, Handedness>(InputSourceType.Eyes, Handedness.None) ,
            new Tuple<InputSourceType, Handedness>(InputSourceType.Head, Handedness.None) ,
